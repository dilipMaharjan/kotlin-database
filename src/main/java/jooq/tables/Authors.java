...
public class Authors extends TableImpl<AuthorsRecord> {
    ...
    private static final long serialVersionUID = 921376154;
     ...
     */
    public final TableField<AuthorsRecord, String> NAME = createField("name", org.jooq.impl.SQLDataType.VARCHAR(60).nullable(false), this, "");
    ...
    public List<UniqueKey<AuthorsRecord>> getKeys() {
        return Arrays.<UniqueKey<AuthorsRecord>>asList(Keys.CONSTRAINT_D, Keys.CONSTRAINT_D9);
    }
